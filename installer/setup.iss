...
begin
  ...
  begin
    ...
    EnvContent[2]  := '';
    EnvContent[3]  := '# Server Configuration';
    EnvContent[4]  := 'PORT=9800';
    EnvContent[5]  := 'CDP_PORT=9222';
    EnvContent[6]  := 'V2_LAN=1';
    EnvContent[7]  := 'USE_HTTPS=true';
    EnvContent[8]  := 'BIND_ADDR=0.0.0.0';
    EnvContent[9]  := '';
    EnvContent[10] := '# Authentication';
    EnvContent[11] := 'PASSWORD=' + PasswordPage.Values[0];
    EnvContent[12] := 'V2_PASSWORD=' + PasswordPage.Values[0];
    EnvContent[13] := 'LOGIN_PASSWORD=' + PasswordPage.Values[0];
    EnvContent[14] := 'JWT_SECRET=' + JwtSecret;
    EnvContent[15] := '';
    EnvContent[16] := '# Paths';
    EnvContent[17] := 'CURSOR_EXE=' + CursorPathPage.Values[0] + '\Cursor.exe';
    EnvContent[18] := 'PROJECTS_ROOT=' + ProjectsPathPage.Values[0];
    EnvContent[19] := 'V2_PROJECTS_ROOT=' + ProjectsPathPage.Values[0];
