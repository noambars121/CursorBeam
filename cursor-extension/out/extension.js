...
function activate(context) {
    ...
    // Register commands
    context.subscriptions.push(vscode.commands.registerCommand('cursor-mobile.start', () => startServer()));
    context.subscriptions.push(vscode.commands.registerCommand('cursor-mobile.stop', () => stopServer()));
    context.subscriptions.push(vscode.commands.registerCommand('cursor-mobile.status', () => showStatus()));
 ...
 */
async function executeAICommand(prompt, res) {
    try {
        ...
        const cursorCommands = allCommands.filter(cmd => cmd.includes('cursor') || cmd.includes('chat') || cmd.includes('ai'));
